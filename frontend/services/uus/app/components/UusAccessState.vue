...
const title = computed(() => {
	if (props.state === 'auth-error') return t('uus.access.authFailedTitle')
	if (props.state === 'telegram-required') return t('uus.access.telegramOnlyTitle')
	return t('uus.access.loadingTitle')
})

const description = computed(() => {
	if (props.state === 'auth-error') return t('uus.access.authFailedDesc')
	if (props.state === 'telegram-required') return t('uus.access.telegramOnlyDesc')
	return t('uus.access.loadingDesc')
})
