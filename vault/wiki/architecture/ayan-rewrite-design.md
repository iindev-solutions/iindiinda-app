# AYAN (Бардыбыт) — Concept

> AYAN — это не такси. Это сервис попутных поездок между людьми.

**Суть**: доска поездок, где люди публикуют маршруты, ищут попутчиков и договариваются напрямую. Без посредников, без оплаты внутри платформы.

---

## Основная идея

Люди уже ездят по маршрутам каждый день: на работу, в другие улусы, в аэропорт, по делам. У них есть свободные места.

AYAN просто соединяет этих людей.
...
Пример: "Еду Якутск → Намцы завтра в 9:00, есть 3 места"

### Пассажир

- ищет поездку по маршруту
- или создаёт запрос "ищу машину"

Пример: "Нужно доехать до Покровска сегодня вечером"

---

## В чём отличие от такси

Это НЕ:
- моментальный вызов машины
- карты с отслеживанием
- алгоритмы подбора

Это:
- заранее запланированные поездки
- поиск попутчиков
...
Минимум на старте:
1. создать поездку (водитель)
2. список открытых поездок
3. откликнуться / написать
...
Идеи → карты, онлайн-трекинг, авто-подбор — это НЕ AYAN на старте.

---

## Регулярные маршруты

Это не разовая поездка. Это может стать постоянной связью между людьми.

Пример:
> Вася едет ДСК → Порт каждый день в 8:30 один в машине. Создаёт поездку "Езжу каждое утро, есть 2 места". Люди из того же района видят и откликаются. Договариваются один раз — дальше ездят вместе каждое утро.

AYAN — это способ сформировать регулярные маршруты и связи между людьми.
