...
### Added
- `vault/wiki/architecture/agal-vision.md` — улучшенный vision-документ для AGAL (Аҕал)

**Улучшения по сравнению с исходным текстом:**
- **4 чётких сценария:** перевозчик едет, отправитель ищет, 🔥 срочная отправка, регулярный маршрут
- **Два типа публикаций:** Маршрут (от перевозчика) + Запрос (от отправителя)
- **Характеристики посылки:** размер, вес, хрупкость (⚠️/💪), документы (📄)
- **Механика отклика:** лимит 3–5 (как в UUS)
- **Уникальность в экосистеме:** единственный межгородний сервис
- **Сильная монетизация:**
  - Комиссия с перевозчика (основная) — он уже летит, для него доп.доход
  - Страховка посылки (опционально)
  - 🔥 Срочная доставка (премиум)
  - Подписка для частых отправителей
- **Потенциал дохода:** 100 маршрутов/день = 15 000 ₽/день = 450 000 ₽/мес
- **Сравнительная таблица** AYAN/UUS/AGAL/TAL
...
| Сервис | Yakut | Статус |
|--------|-------|--------|
| **AYAN** (Бардыбыт) | Попутки | ✅ Vision complete |
| **UUS** (Уус) | Услуги | ✅ Vision complete |
| **TAL** (Тал) | Запись | ✅ Vision complete |
| **AGAL** (Аҕал) | Доставка | ✅ Vision complete |

**Все 4 сервиса готовы к Implementation Phase!**
