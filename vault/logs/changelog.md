...
- **Единый принцип:** один интерфейсный паттерн для всех сервисов (заявка → отклик → договор)
- **Платформенная ценность:**
  - Единый профиль (один аккаунт — все сервисы)
  - Кросс-активность (водитель AYAN видит UUS-задачи)
  - Единое доверие (репутация переносится между сервисами)
  - Локальный рынок (деньги остаются внутри сообщества)
- **Монетизация платформы:**
  - Бесплатно для заказчиков, платят исполнители (честно)
  - Кросс-продвижение, пакетные подписки
  - Сервисная монетизация: AYAN (продвижение), UUS (отклики), TAL (подписки), AGAL (комиссия)
- **Конкретные цели:** 6 месяцев (5k users, 200 транзакций/день), 12 месяцев (20k users, 1k транзакций/день, 300–500k ₽/мес)
